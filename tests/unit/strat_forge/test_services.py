...
from strat_forge.services import Service
...
class TestGettingServiceDomain:
    ...
    def test_should_raise_invalid_domain_for_the_base_service(self) -> None:
        ...
        with pytest.raises(
            ...
            match="You should use a specific service implementation",
        ):
            Service.domain

    def test_should_import_the_configured_domain_module_for_a_specific_service(
        self,
    ) -> None:
